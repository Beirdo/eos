...
void wallet_api_plugin::plugin_startup() {
   ...
   app().get_plugin<http_plugin>().add_api({
       ...
       CALL(wallet, wallet_mgr, sign_transaction,
            INVOKE_R_R(wallet_mgr, sign_transaction, wallet_plugin::sign_transaction_options), 201),
       CALL(wallet, wallet_mgr, sign_digest,
            INVOKE_R_R(wallet_mgr, sign_digest, wallet_plugin::sign_digest_options), 201),
